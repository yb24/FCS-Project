# Generated by Django 4.0.3 on 2022-11-27 21:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vAadhar', models.FileField(blank=True, null=True, upload_to='post_images', validators=[patient_mgmt_backend.validators.validate_file_size, patient_mgmt_backend.validators.validate_file_extension])),
                ...
                ('image1Path', models.FileField(blank=True, null=True, upload_to='post_images', validators=[patient_mgmt_backend.validators.validate_file_size, patient_mgmt_backend.validators.validate_file_extension])),
                ('title3', models.CharField(max_length=200)),
                ('content3', models.TextField()),
                ('image2Path', models.FileField(blank=True, null=True, upload_to='post_images', validators=[patient_mgmt_backend.validators.validate_file_size, patient_mgmt_backend.validators.validate_file_extension])),
